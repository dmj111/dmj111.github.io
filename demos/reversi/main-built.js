...
define('app/display',['./board'], function(my) {
...
define('app/game',['./board'], function(my) {
...
define('app/util',['./board'], function(my) {
...
define('app/scoreFunctions',['./board'], function(my) {
...
define('app/alphabeta',['./board'], function(my) {
...
define('app/alphabeta6',['./board'], function (my) {
...
define('app/randomPlayer',['./board'], function(my) {
...
define('app/bayesplayer',['./board'], function (my) {
...
/* globals define, console */
define('app/bayesscore',['./board'], function(my) {
...
define('app/phaseplayer',['./board'], function(my) {
...
define('app/semirandomplayer',['./board'], function(my) {
...
define('app/uiplayer',['./board'], function (my) {
...
define('app/reversi',['./board',
        ...
        './phaseplayer',
        './semirandomplayer',
        './uiplayer'], function(my)
       {
           'use strict'
           return my;
       });

/* globals define,reversi, reversiLearnerCounts, document */

define('reversiUi',['app/reversi', 'learner'], function(reversi) {
...
require(['app/reversi', 'reversiUi'], function(reversi, reversiUi) {
